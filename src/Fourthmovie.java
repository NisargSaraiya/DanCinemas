 ...
 * @author manoj
 */
public class Fourthmovie extends javax.swing.JFrame {
Connection con ;
 void opencon(){
     try{
  ...
  f9.setEnabled(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fourthmovie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Fourthmovie().setVisible(true);
            }
        });
    }
