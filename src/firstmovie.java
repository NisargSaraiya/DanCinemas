 ...
 * @author manoj
 */
public class firstmovie extends javax.swing.JFrame {
          
    
    /**
     * Creates new form firstmovie
     */
    public firstmovie() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        aw = new javax.swing.JToggleButton();
        ...
        d.setMaxSelectableDate(new java.util.Date(1538859713000L));
        d.setMinSelectableDate(new java.util.Date(1538341313000L));
 ...
 void opencon(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(firstmovie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new firstmovie().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JToggleButton aw;
